...
`,xe="M41.1,101.17c-20.64-18.34-16.35-28.5-15.85-54.84c0-0.24,0.04-0.47,0.12-0.67l-5.19-1.63c-0.74-16.4,8.75-26.21,20.52-30.93c4.28-1.72-2.89-11.1,6.97-7.49c13.17,4.82,42.39,11.38,49.31,19.65c5.62,6.72,5.85,10.36,5.72,19.13c-0.04,2.85-0.48,5.34-1.79,6.27c-0.61,0.43-1.33,0.6-2.18,0.52c0,16.27,2.19,31.67-9.56,44.92c-6.97,7.86-17.48,12.9-28.06,12.74c-4.17-0.07-6.75-0.66-10.35-2.01C47.21,105.49,44.27,103.98,41.1,101.17z",be="M53.28,103.38c2.09,0.83,5.99,1.24,8.26,1.24c4.47,0,8.99-1.01,13.19-2.93c4.22-1.92,8.11-4.73,11.3-8.33c10.71-12.09,8.51-27.51,8.51-42.42h0.01c-0.04-1.33-0.24-2.54-0.6-3.65c-0.35-1.07-0.85-2-1.52-2.79c-2.56-3-4.98-2.88-8.44-2.7c-0.32,0.01-0.62,0.03-1.07,0.06c-13.68,0.6-22.64,0.59-29.91-0.04c-6.7-0.6-11.96-1.7-18.1-3.32c-0.58,1.36-1.25,2.69-2.03,3.98c-1,1.65-2.16,3.23-3.49,4.73c-0.46,24.62-4.75,33.82,14.46,50.87c1.09,0.97,2.24,1.83,3.43,2.57C48.99,101.7,51.51,102.81,53.28,103.38z",ve="M77.25,62.33c2.31,0,4.19,1.87,4.19,4.18c0,2.31-1.87,4.19-4.19,4.19s-4.19-1.88-4.19-4.19C73.06,64.2,74.94,62.33,77.25,62.33z",$e="M45.61,62.33c2.31,0,4.19,1.87,4.19,4.18c0,2.31-1.87,4.19-4.19,4.19c-2.31,0-4.19-1.88-4.19-4.19C41.43,64.2,43.3,62.33,45.61,62.33z",Me=["M49,87 C49,87 55,97 61,97 C67,97 73,87 73,87 C73,87 67,93 61,93 C55,93 49,87 49,87 Z","M54.12,90.87c-1.01-0.55-1.37-1.81-0.81-2.81c0.55-1,1.81-1.37,2.81-0.81c1.9,1.05,3.74,1.62,5.5,1.66c1.71,0.03,3.4-0.44,5.07-1.46c0.97-0.6,2.24-0.3,2.84,0.67c0.6,0.97,0.3,2.25-0.67,2.84c-2.37,1.46-4.81,2.13-7.31,2.08C59.07,92.98,56.6,92.24,54.12,90.87z","M50,88 L72,88 L72,90.5 L50,90.5 Z","M49,92 C49,92 55,86 61,86 C67,86 73,92 73,92 C73,92 67,89 61,89 C55,89 49,92 49,92 Z","M47,94 C47,94 54,84 61,84 C68,84 75,94 75,94 C75,94 68,88 61,88 C54,88 47,94 47,94 Z","M55,83 C55,79 58,77 61,77 C64,77 67,79 67,83 L67,93 C67,97 64,99 61,99 C58,99 55,97 55,93 Z","M53,82 C53,77 57,74 61,74 C65,74 69,77 69,82 L69,95 C69,100 65,103 61,103 C57,103 53,100 53,95 Z"];let ze=class extends dt{constructor(){super(...arguments),this.pm25=0}static{this.styles=a`
  ...
  `}_getLevel(){for(let t=0;t<vt.length;t++)if(this.pm25<=vt[t].max)return t;return vt.length-1}_renderFace(t,e){const i=t>=5,r=[xe,be,ve,$e,t>=4?"M73,56 L85,52 L85,54.5 L73,58.5 Z M49,56 L37,52 L37,54.5 L49,58.5 Z":"M86.77,60.28c0.6,0.8,0.44,1.95-0.37,2.55c-0.8,0.6-1.95,0.44-2.55-0.37c-1.46-1.95-3.01-2.97-4.65-3.36c-1.67-0.4-3.49-0.14-5.39,0.49c-0.96,0.32-1.99-0.19-2.3-1.15c-0.31-0.96,0.19-1.99,1.15-2.3c2.49-0.84,4.97-1.16,7.36-0.59C82.47,56.13,84.75,57.59,86.77,60.28z M42.85,55.55c2.39-0.57,4.87-0.25,7.36,0.59c0.96,0.32,1.47,1.35,1.15,2.3c-0.32,0.96-1.35,1.47-2.3,1.15c-1.88-0.64-3.71-0.88-5.39-0.49c-1.63,0.39-3.2,1.42-4.65,3.36c-0.6,0.8-1.74,0.97-2.55,0.37c-0.8-0.6-0.97-1.74-0.37-2.55C38.14,57.59,40.42,56.13,42.85,55.55z",Me[t]??Me[4]].join(" ");return V`
    ...
    `}_renderMoon(){if(this.elevation>=-6)return"";if(!this.moonPhase)return"";if(!xt.includes(this.condition))return"";const t=ue(this.moonPhase);return q`
      <div class="moon-icon">
        ${ke(t)}
      </div>
    `}_onIconClick(){this.dispatchEvent(new CustomEvent("icon-click",{bubbles:!0,composed:!0}))}_onIconKeyDown(t){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this._onIconClick())}render(){const t=this._getSkyClass(),e=this._getSkyStyle(),i=wt.includes(this.condition),r=pe(this.condition),s=kt[this.condition]??this.condition;return q`
...
`,He=["#1976D2","#00ACC1","#43A047","#FDD835","#FB8C00","#E53935"],Be=150,Pe=150,je=90,Re=210,Ie=240;function Le(t,e,i,r){const s=r*Math.PI/180;return[t+i*Math.cos(s),e-i*Math.sin(s)]}let De=class extends dt{constructor(){super(...arguments),this.speed=0,this.maxSpeed=50}get _safeMax(){return this.maxSpeed>0?this.maxSpeed:50}static{this.styles=Te}_renderColorBands(){const t=Ie/He.length;return He.map((e,i)=>{const r=Re-i*t;return V`
        <path
          d=${function(t,e){const[i,r]=Le(Be,Pe,je,t),[s,o]=Le(Be,Pe,je,e),a=t-e;return`M ${i},${r} A 90,90 0 ${Math.abs(a)>180?1:0},1 ${s},${o}`}(r,r-t)}
          fill="none"
          stroke=${e}
          stroke-width="18"
          stroke-linecap="butt"
        />
      `})}_renderTicks(){const t=[],e=this._safeMax>=100?20:10,i=this._safeMax>=100?10:2;for(let r=0;r<=this._safeMax;r+=i){const i=r/this._safeMax,s=Re-i*Ie,o=r%e===0,a=r%(e/2)==0&&!o,n=96,l=o?106:a?102:99,[d,c]=Le(Be,Pe,n,s),[f,h]=Le(Be,Pe,l,s);if(t.push(V`
        <line
          x1=${d} y1=${c} x2=${f} y2=${h}
          stroke="rgba(255,255,255,${o?.8:a?.5:.3})"
          stroke-width=${o?1.5:a?1:.7}
        />
      `),o){const[e,i]=Le(Be,Pe,112,s);t.push(V`
          <text
            x=${e} y=${i}
            text-anchor="middle"
            dominant-baseline="central"
            ...
            font-weight="600"
          >${r}</text>
        `)}}return t}_renderIcons(){return[{angle:215,idx:0},{angle:162,idx:1},{angle:114,idx:2},{angle:66,idx:3},{angle:18,idx:4},{angle:-35,idx:5}].map(({angle:t,idx:e})=>{const[i,r]=Le(Be,Pe,122,t),s=18;return V`
    ...
    `}};t([ut({type:Number})],De.prototype,"speed",void 0),t([ut({type:Number})],De.prototype,"maxSpeed",void 0),De=t([ft("wdb-wind-gauge")],De);const qe=a`
  :host {
    display: block;
  }
...
`;let Ve=class extends dt{constructor(){super(...arguments),this.name="",this.value="",this.unit="",this.icon="",this.entityId="",this.statKey=""}static{this.styles=qe}_onClick(){this.entityId&&this.dispatchEvent(new CustomEvent("stat-click",{bubbles:!0,composed:!0,detail:{key:this.statKey,entityId:this.entityId,name:this.name,unit:this.unit,icon:this.icon}}))}_onKeyDown(t){"Enter"!==t.key&&" "!==t.key||(t.preventDefault(),this._onClick())}render(){const t=!!this.entityId;return q`
      <div
